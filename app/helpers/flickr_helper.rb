module FlickrHelper 
  ...
  def render_flickr_slideshow
    rescue_flickr do
      ...
      render '/flickr/slideshow', :locals => { :photos => photos }
    end
  end
  
  def render_flickr_projects
    rescue_flickr do
      photos = get_photo_tags('pilots')
      render '/flickr/projects', :locals => { :photos => photos }
    end
  end
  ...
  private
    ...
    def rescue_flickr(&blk)
      ...
      render '/flickr/unavailable', :locals => { :error => error }
    end
end